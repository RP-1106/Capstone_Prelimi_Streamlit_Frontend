...
# st.sidebar.title("Butterfly Menu")
# choice = st.sidebar.radio("Navigate", ["Sea", "Ocean", "Beach"])

# st.title("Butterfly Page")

# if choice == "Sea":
#     st.write("Welcome to the Sea section!")
# elif choice == "Ocean":
#     st.write("Explore the Ocean section!")
# elif choice == "Beach":
#     st.write("Enjoy the Beach section!")
...
# st.set_page_config(
#     page_title="Financial Butterfly Effect Simulator",
#     layout="wide",
...
st.markdown('<h1 class="title"> Butterfly Effect Simulator</h1>', unsafe_allow_html=True)
st.markdown(
