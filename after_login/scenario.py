...
# st.sidebar.title("Scenario Menu")
# choice = st.sidebar.radio("Navigate", ["Forest", "Desert", "Land"])

# st.title("Scenario Page")

# if choice == "Forest":
#     st.write("Welcome to the Forest section!")
# elif choice == "Desert":
#     st.write("Explore the Desert section!")
# elif choice == "Land":
#     st.write("Discover the Land section!")
...
# st.set_page_config(
#     page_title=" Financial Scenario Tester",
#     page_icon="₹",
#     layout="wide",
